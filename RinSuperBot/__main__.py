...
❆ I'ᴍ Aɴ Aɴɪᴍᴇ-Tʜᴇᴍᴇ Mᴀɴᴀɢᴇᴍᴇɴᴛ Rᴏʙᴏᴛ [✨](https://telegra.ph/file/23a2e22dcc2187f6478fd.jpg) 
...
❆ Hɪᴛ /Hᴇʟᴘ Tᴏ Sᴇᴇ Mʏ Aᴠᴀɪʟᴀʙʟᴇ Cᴏᴍᴍᴀɴᴅs.
"""
...
➲ /help  : Aᴠᴀɪʟᴀʙʟᴇ Cᴏᴍᴍᴀɴᴅꜱ Sᴇᴄᴛɪᴏɴ.
  ❆ Iɴ Pᴍ : Wɪʟʟ Sᴇɴᴅ Yᴏᴜ Hᴇʟᴘ​ Fᴏʀ Aʟʟ Sᴜᴘᴘᴏʀᴛᴇᴅ Mᴏᴅᴜʟᴇꜱ.
  ❆ Iɴ Gʀᴏᴜᴘ : Wɪʟʟ Rᴇᴅɪʀᴇᴄᴛ Yᴏᴜ Tᴏ Pᴍ, Wɪᴛʜ Aʟʟ Tʜᴀᴛ Hᴇʟᴘ​ Mᴏᴅᴜʟᴇꜱ."""

DONATE_STRING = """Hᴇʏ Bᴀᴋᴀ,
  Hᴀᴩᴩʏ Tᴏ Hᴇᴀʀ Tʜᴀᴛ Yᴏᴜ Wᴀɴɴᴀ Dᴏɴᴀᴛᴇ.

Yᴏᴜ Cᴀɴ Dɪʀᴇᴄᴛʟʏ Cᴏɴᴛᴀᴄᴛ Mʏ, [Dᴇᴠᴇʟᴏᴘᴇʀ](https://t.me/spryslade) Fᴏʀ Dᴏɴᴀᴛɪɴɢ Oʀ Yᴏᴜ Cᴀɴ Vɪsɪᴛ Mʏ [Sᴜᴩᴩᴏʀᴛ Cʜᴀᴛ](https://t.me/AstorSupport) Aɴᴅ Asᴋ Tʜᴇʀᴇ Aʙᴏᴜᴛ Dᴏɴᴀᴛɪᴏɴ."""
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAx0CXJU7zQABCaPrYxS9EvnflFgBI-BOAUKerLPvGG0AAg0FAALYUxFVbaZ-Ng1lOaQeBA"
            )
            update.effective_message.reply_text(
